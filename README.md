...
### בפרוייקט הצלחתי לממש 3 design patterns  אבל אני רוצה להזכיר בשורה הזאת את הgeneric repository 
...
![alt text](https://github.com/orshani1/EntityFrameWork_Project/blob/Main/smtp.PNG?raw=true)
